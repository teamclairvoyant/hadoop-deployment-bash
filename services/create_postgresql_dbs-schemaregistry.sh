...
# main
echo "Creating users and databases in PostgreSQL for Schema Registry..."
...
REGISTRYDB_PASSWORD=$(eval "$PWCMD")
echo "****************************************"
echo "****************************************"
echo "****************************************"
echo "*** SAVE THIS PASSWORD"
$ECHO psql -h "$PG_HOST" -p "$PG_PORT" -U "$PG_USER" postgres -c "CREATE DATABASE registry;"
$ECHO psql -h "$PG_HOST" -p "$PG_PORT" -U "$PG_USER" postgres -c "CREATE USER registry WITH PASSWORD '$REGISTRYDB_PASSWORD';"
$ECHO psql -h "$PG_HOST" -p "$PG_PORT" -U "$PG_USER" postgres -c 'GRANT ALL PRIVILEGES ON DATABASE "registry" to registry;'
echo "registry : $REGISTRYDB_PASSWORD"
echo "****************************************"
echo "****************************************"
echo "****************************************"
